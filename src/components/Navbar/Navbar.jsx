...
export default function Navbar({ onTriggerSlash }) {
  ...
  return (
    <div className="fixed top-6 right-6 z-50 font-mono text-xs select-none">
      {/* Desktop Top-Right Navigation Menu */}
      <div className="hidden md:flex items-center gap-6 bg-[#111116]/80 backdrop-blur-md border border-white/15 px-5 py-2.5 rounded-full shadow-2xl">
